...
from recipesdb import Recipe, Base, User
...
menuItem2 = Recipe(user_id=1, name="Pancakes", instructions="Purchase your favorite box of pancake mix.  Mix and cook on flat top griddle.  Add your favorite fruit and syrup.  Enjoy.",
                     type="Main Dish", picture"https://www.pexels.com/photo/blur-breakfast-close-up-dairy-product-376464/")

session.add(menuItem2)
session.commit()


menuItem1 = Recipe(user_id=1, name="Mixed Fruit", instructions="Purchase your favorite fruits from the grocery store.  Slowly pour them all into a bowl.  Cover the bowl and spin on a counter.  Remove the cover and enjoy.",
                     type="Appetizer", picture"https://images.pexels.com/photos/87818/background-berries-berry-blackberries-87818.jpeg"

session.add(menuItem1)
session.commit()

menuItem2 = Recipe(user_id=1, name="Baked Mac N Cheese", instructions="Boil macaroni noodles. Create cheese sauce using your favorite cheese.  Add cheese sauce to cooked noodles.  Top with breadcrumbs and bake.  Let stand for 15 minutes then serve.",
                     type="Side Dish", picture"https://www.pexels.com/photo/close-up-photography-of-baked-mac-806357/"

session.add(menuItem2)
session.commit()

menuItem3 = Recipe(user_id=1, name="Feeling Good", instructions="Pour fruit juice in cup.  Add your favorite soda.  Enjoy.",
                     type="Beverage", picture"https://images.pexels.com/photos/109275/pexels-photo-109275.jpeg"

session.add(menuItem3)
session.commit()

menuItem4 = Recipe(user_id=1, name="Pick One", instructions="Choose the one that looks best.  Bottom's Up!",
                     type="Beverage", picture"https://images.pexels.com/photos/605408/pexels-photo-605408.jpg"
